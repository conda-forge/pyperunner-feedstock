...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyperunner-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11736&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyperunner-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyperunner` can be installed with:

```
conda install pyperunner
```

It is possible to list all of the versions of `pyperunner` available on your platform with:
